...
ActiveRecord::Schema.define(version: 20160905154609) do
  ...
  create_table "numbers", primary_key: "id_number", force: :cascade do |t|
    t.integer "numero",            precision: 38, null: false
